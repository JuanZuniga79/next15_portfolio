...
const skills: ISkill[] = [
	{
		...
		skills: [
			...
			},
			{
				...
				frequency: "weekly",
				level: "intermediate",
				relatedSkills: ["django", "fastapi", "reactPy", "numpy", "pygames"],
			},
			{
				icon: GoIcon,
				name: "go",
				...
				frequency: "monthly",
				level: "novice",
				relatedSkills: ["grpc", "protobuf", "docker", "kubernetes"],
			},
			{
				icon: RustIcon,
				name: "rust",
				...
				frequency: "monthly",
				level: "beginner",
				relatedSkills: ["wasm", "linux", "unix", "rocket"],
			},
			{
				icon: CIcon,
				name: "c",
			...
			},
			{
				...
				frequency: "monthly",
				level: "beginner",
				relatedSkills: ["linux", "unix", "video games"],
			},
			{
				icon: SQLIcon,
				name: "sql",
